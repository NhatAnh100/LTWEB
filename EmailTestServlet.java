...
public class EmailTestServlet extends HttpServlet {
	...
	protected void sendTestEmail(String email) {
        ...
        //Gửi
        String subject = "RING! - productstore advertisement email!";
        String content = "<h1 style=\"font-family:Roboto; color:#63e399\">RING!</h1>\n"
        		+ "<br><h2 style=\"font-family:Roboto; color:white; background-color:#63e399; text-align:center\">Tài khoản RING! - productstore của bạn đã đăng ký nhận tin!</h2>\n \n"
        		+ "<br><br><p>Bạn đã đăng ký nhận tin nhắn quảng cáo của web RING! - productstore</p>";
