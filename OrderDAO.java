...
public class OrderDAO {
	...
	public List<OrderDetail> getOrderByproducts(){ //for admin
		
		List<OrderDetail> list = new ArrayList<>();
		String query = "select top 10 productid, sum(amount) as SL from OrderDetail group by productid order by SL desc";
		try {
