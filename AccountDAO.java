...
public class AccountDAO {
	...
	public List<Account> getAllAccount(){ //for admin
		...
		List<Account> list = new ArrayList<>();
		String query = "select a.*, count(b.sellID) as SL from account a left join product b on a.id = b.sellID\r\n" + 
...
//				if (rs.getInt(5) == 1) {
//					temp.setTotalproducts(rs.getInt(7));
//				}
	...
	public List<Account> getTop5Seller(){ //for admin
		...
		String query = "select top 5 a.userName, count(b.sellID) as SL \r\n" + 
				"from account a join product b on a.id = b.sellID \r\n" + 
		...
		try {
			...
			while(rs.next()) {
				...
				temp.setTotalproducts(rs.getInt(2));
